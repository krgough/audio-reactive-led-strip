...
vizualization.py for the main sound to light show
led.py for a test led.pattern
...
Notes on the Audio Reactive Strip Code:

# Code format
The code is using a lot of global vars and has other formatting issues that really need to be tidied up.

# Link to original repo
https://github.com/scottlawsonbc/audio-reactive-led-strip

# Link to apa102 library (leds are apa102s)
https://github.com/pimoroni/apa102-python
